...
parser.add_argument('--load_model_path', default="STM_VSOD.pt", type=str)

# path to the parent directory of dataset
parser.add_argument('--test_video_dir', default="/path/to/test", type=str)
# name of the dataset
...
def main_worker(local_rank, nprocs, args):
    ...
    dist.init_process_group(backend='nccl', init_method='tcp://127.0.0.1:24568', world_size=args.nprocs, rank=local_rank)
    ...
    test_loader = torch.utils.data.DataLoader(test_dataset, batch_size=args.batch_size_eval, pin_memory=True,
                                                     drop_last=False, shuffle=False, sampler=test_sampler, num_workers=6)
